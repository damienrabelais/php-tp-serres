...
while($enregistrement = $stmt->fetch())
{
  ...
  echo '<tr><td>'.$enregistrement->noregion.'</td><td><a href=http://localhost/serres/plantespouruneregion.php?numeroRegion='.$enregistrement->noregion.'>'.$enregistrement->nomregion.'</a></td><tr>';
}
echo "</table>";
?>
</body>
